...
export function Footer() {
  ...
  return (
    <footer
      ref={footer}
      className="flex flex-col align-center gap-2 items-center justify-center md:opacity-0 w-full mx-auto mt-20 md:mb-8 py-16 px-9 bg-neutral-800 rounded-t-4xl md:rounded-full dark:bg-white"
    >
